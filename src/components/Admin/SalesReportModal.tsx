...
export default function SalesReportModal({ onClose }: SalesReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-fadeIn">
      <div className="relative w-full max-w-4xl bg-white border border-gray-200 rounded-3xl p-6 shadow-2xl text-gray-900 overflow-hidden transform transition-all animate-scaleUp space-y-5 max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-extrabold text-gray-900 font-sans">
                Зарагдсан Барааны Нэгтгэсэн Тайлан
              </h3>
              <p className="text-xs text-gray-500 font-sans mt-0.5">
                Нийт борлуулалтын тоо хэмжээ, орлого болон ашгийн тооцоо
              </p>
            </div>
          </div>
