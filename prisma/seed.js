...
async function main() {
  ...
  await prisma.bankQR.deleteMany();
  await prisma.promotionBanner.deleteMany();

  // Create Categories
  const catPens = await prisma.category.create({
  ...
  console.log('✅ Категориуд үүсгэгдлээ.');
  ...
  console.log('✅ Бараанууд үүсгэгдлээ.');

  // Create Bank QR codes (2-3 Banks)
  await prisma.bankQR.createMany({
    data: [
      {
  ...
  console.log('✅ Банкны QR тохиргоонууд үүсгэгдлээ.');
  ...
  console.log('✅ Промошн баннер үүсгэгдлээ.');
